...
fn do_it(kernel_shape: (usize, usize), img_shape: (usize, usize)) -> f32 {
    ...
    let mut output = RwLock::new(Vec::new());
    let arcput = Arc::new(output);
